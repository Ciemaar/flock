...
def test_empty_tagset():
    """Docstring for test_empty_tagset."""
...
def test_basic_tagset():
    """Docstring for test_basic_tagset."""
    test_obj = SimpleObj()
    ...
    for t in tagset["test"]:
        assert t in {test_obj.class_attr, "test_class_attr", test_obj.instance_attr, "test_instance_attr"}
